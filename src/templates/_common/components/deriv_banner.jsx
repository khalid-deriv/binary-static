...
const DerivBanner = ({ has_margin }) => (
    <React.Fragment>
        <div id='deriv_banner_container' className={`invisible ui-helper-clearfix ${has_margin ? 'has_margin' : ''}`}>
            <a target='_blank' rel='noopener noreferrer' href={`${it.deriv_banner_url}interim/faq/?t=${it.affiliate_token}&utm_source=binary&utm_medium=referral&utm_campaign=ww-banner-deriv-1020-en&utm_content=deriv-banner-rebranding`}>
        ...
        <div id='multiplier_banner_container' className={`invisible ui-helper-clearfix ${has_margin ? 'has_margin' : ''}`}>
            <a target='_blank' rel='noopener noreferrer' href={`${it.deriv_banner_url}trade-types/multiplier/?t=${it.affiliate_token}&utm_source=binary&utm_medium=referral&utm_campaign=ww-banner-deriv-1020-en&utm_content=multiplier-banner-synthetic-indices-amplified`}>
